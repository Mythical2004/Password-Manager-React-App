    ...
    return (
        <>
            ...
            <div className="static lg:mx-[250px] bg-slate-200  p-1 flex flex-col items-center">
                ...
                <button className='justify-center items-center flex bg-green-500 p-2 rounded-full hover:bg-green-700 transition-all duration-300' onClick={savePassword}>
                    <lord-icon
                ...
                <div className="passwords w-full xl:min-w-[60vw] mt-5 ">
                    <h1 className='font-bold'>Your Passwords</h1>
                    {passwordArray.length === 0 && <div className='mt-5'>No passwords to Show </div>}
                    {passwordArray.length !== 0 && <table className="table-auto min-w-[90%] bg-green-50 overflow-hidden rounded-sm mx-[5%]">
                        ...
                        <tbody>
                            {passwordArray.map((item, index) => {
                                return <tr key={index} >
                                    ...
                                    <td className='  border border-black  text-center py-1 justify-center items-center'>{item.password}
                                    ...
                                    <td className='  border border-black  text-center py-1 justify-center items-center'>
                                        ...
                                        <span className='cursor-pointer' onClick={()=>{deletePassword(item.id, true)}}>
                                            <lord-icon
